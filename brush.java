...
class evbrush extends brush{
	
	public evbrush(){
		bristles = 9;
		xlocs = new int[9][1];
		ylocs = new int[9][1];
		xlocs[0][0] = 0; xlocs[1][0] = 0; xlocs[2][0] = -2;
		ylocs[0][0] = -2; ylocs[1][0] = -1;ylocs[2][0] = 0;
		xlocs[3][0] = -1; xlocs[4][0] = 0; xlocs[5][0] = 1;
		ylocs[3][0] = 0; ylocs[4][0] = 0; ylocs[5][0] = 0;
		...
		//sets expansion factor
		private void setXF(){ 
			xlocs[0][0] = 0; xlocs[1][0] = 0; xlocs[2][0] = -2*xf;
			ylocs[0][0] = -2*xf; ylocs[1][0] = -1*xf;ylocs[2][0] = 0;
			xlocs[3][0] = -1*xf; xlocs[4][0] = 0; xlocs[5][0] = xf;
			ylocs[3][0] = 0; ylocs[4][0] = 0; ylocs[5][0] = 0;
			xlocs[6][0] = 2*xf; xlocs[7][0] = 0; xlocs[8][0] = 0;
			ylocs[6][0] = 0; ylocs[7][0] = xf; ylocs[8][0] = 2*xf;
		}
