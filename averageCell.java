...
class minCell extends cell{
	...
	public minCell(){
		...
		private void calculate(){
			int min = neighborstate[0];
			for(int count = 0; count < neighborstate.length; count++){
				if(count == 4){}
				else{if(neighborstate[count] < min){min = neighborstate[count];}}
...
class maxCell extends cell{
	...
	public maxCell(){
		...
		private void calculate(){
			int max = neighborstate[0];
			for(int count = 0; count < neighborstate.length; count++){
				if(count == 4){}
				else{if(neighborstate[count] > max){max = neighborstate[count];}}
